...
- [ ] 全文检索^1
- [ ] 有道等在线词库增强
- [ ] 单词超链点击查词(释义内任意单词可点击跳转,类 macOS Dictionary)#259
- [ ] 词典卡死/性能问题排查(部分大词典卡顿)#259
- [ ] 词典元信息自动填充(从 mdx 读名称/别名,文件名兜底)+ 从任意目录添加 #259
- [ ] 词典 CSS 编辑器(右键编辑 + 实时预览)#259
- [ ] 导出当前词条 HTML 为文件(调试复杂词条)#259
- [ ] MDX 打包/解包工具 #259
- [ ] 词形/简繁/异体字变形查询(查不到时回退变形,或提示「你是不是要查…」)#259
- [ ] 插件功能
  - [ ] 词典扩展功能栏
  - [ ] 词频展示插件
  - [x] 生词本记录插件
