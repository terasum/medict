...
<div style="width: 100%;">
  <img  width=500 style="display:block; margin: 0 auto;"  src="src/assets/docs/pic_dict_window.jpg" alt="词典界面" style="zoom: 23%;" />
</div>

### 翻译界面

<div style="width: 100%;">
<img  width=500 style="display:block; margin: 0 auto;"  src="src/assets/docs/pic_translate_window.jpg" alt="翻译界面" style="zoom: 23%;" />
</div>

### 设置界面

<div style="width: 100%;">
  <img  width=500 style="display:block; margin: 0 auto;"  src="src/assets/docs/pic_settings_window.jpg" alt="设置界面" style="zoom: 23%;" />
</div>
...
<div style="width: 100%;">
    <img width=500 style="display:block; margin: 0 auto;" src="src/assets/docs/pic_add_dict_btn.jpg" alt="pic_add_dict_btn.jpg" style="zoom: 23%;" />
</div>
...
<div>
  <img width=500 style="display:block; margin: 0 auto;"  src="src/assets/docs/pic_add_dict_modal.jpg" alt="pic_add_dict_modal.jpg" style="zoom:23%;" />
</div>
...
<div>
  <img width=500 style="display:block; margin: 0 auto;" src="src/assets/docs/pic_usage_step1.jpg" alt="pic_usage_step1.jpg" style="zoom:23%;" />
</div>

2. 在左边栏选择你想要查的具体词汇, 如果该词汇和其他词汇同一个意思（即@@Link==） 则直接展示该同意义词汇

<div>
<img width=500 style="display:block; margin: 0 auto;" src="src/assets/docs/pic_usage_step2.jpg" alt="pic_usage_step2.jpg" style="zoom:23%;" />
</div>
